...
|  | Name | Description | Discount Code & Terms |
| -- | ---| ------ | ------ |
|  🤑 | [Howuku](https://howuku.com) | Howuku is a behavior analytics tool to help startups visualize the complete user journey through heatmaps, session recordings, AB testing, surveys, analytics, and more.| 50% OFF on any plan with code **BLACKFRIDAY** |
